...
<html lang="jp">
    <head>
        <meta charset="UTF-8">
        <title>栗田孟 ポートフォリオ</title>
        <link rel="stylesheet" href="style.css">
        <link rel="stylesheet" href="css/slick.css">
        <link rel="stylesheet" href="css/slick-theme.css">
        <link rel="stylesheet" href="recruit.css">
        <link rel="stylesheet" href="recruit-new.css">
            ...
            <div class="recruit-header-content">
                <div class="recruit-header-links">
                    ...
                    <div class="header-btn-2">
                        <a class="recruit-header-link-2 link" href="http://portfolio.local/enviroment-2/">Jime Companyでの働き方</a>
